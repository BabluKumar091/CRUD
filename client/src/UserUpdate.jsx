...
const UserUpdate = ({ onUpdate }) => {
  ...
  useEffect(() => {
    axios
      .get("https://crud-backend-g8kk.onrender.com/getUser/" + id)
      .then((res) => {
  ...
  const updateUser = (e) => {
    e.preventDefault();
    axios
      .put("https://crud-backend-g8kk.onrender.com/updateUser/" + id, {
        name,
        email,
        age,
      })
      ...
      <div className="container flex justify-center mx-auto">
        <div className="w-1/2 bg-white rounded-lg shadow-lg p-6 mt-10">
          <form onSubmit={updateUser}>
            ...
            <button className="bg-green-500 p-2 rounded-sm text-black mt-4 cursor-pointer">
              Update
            </button>
          </form>
        </div>
